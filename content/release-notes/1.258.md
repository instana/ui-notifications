...
The ECMAScript modules support is added for AWS Fargate for Node.js tracer. For more information, see [ECMAScript modules](https://www.ibm.com/docs/en/instana-observability/saas?topic=agents-aws-fargate#ecmascript-modules).
