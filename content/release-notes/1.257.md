...
- Now you can create a tracing configuration file for each IBM MQ queue manager. For more information, see [Configuring IBM MQ Tracing for on-premises IBM MQ](https://www.ibm.com/docs/en/instana-observability/saas?topic=mq-tracing#configuring-ibm-mq-tracing-for-on-premises-ibm-mq).
- Now you can specify the location for IBM MQ Tracing log files. For more information, see [Log files for IBM MQ Tracing](https://www.ibm.com/docs/en/instana-observability/saas?topic=mq-tracing#log-files-for-ibm-mq-tracing).
...
You can create table widgets in custom dashboards for Infrastructure and Platforms. For more information, see [Table widget](https://www.ibm.com/docs/en/instana-observability/saas?topic=dashboards-example-table#creating-a-table-widget-for-infrastructure-and-platforms-technology-preview).
