...
Instana now supports the increase aggregation for metrics in [custom dashboards](https://www.ibm.com/docs/en/instana-observability/saas?topic=instana-building-custom-dashboards) and [Analyze Infrastructure](https://www.ibm.com/docs/en/instana-observability/saas?topic=analytics-analyze-infrastructure). For more information, see [Aggregations](https://www.ibm.com/docs/en/instana-observability/saas?topic=dashboards-how-aggregations-work).
...
For more information, see [Synthetic monitoring Limited access](https://www.ibm.com/docs/en/instana-observability/saas?topic=instana-managing-user-access#synthetic-monitoring-limited-access).

### Unit selection for custom metrics
You can now select a unit for custom infrastructure metrics on custom dashboards. For more information, see [Unit for custom metric](https://www.ibm.com/docs/en/instana-observability/saas?topic=dashboards-example-infrastructure#unit-for-custom-metric).
